            ...
            <Fragment>
                <div className="row download_tab">
                    ...
                    <div className="col-lg-6 col-md-7 donwload_tab_right">
                        <Link to="/"><img className="img-fluid download_img" src="assets/img/index/Apple Store.png" width="280"  alt=""/></Link> &nbsp;
                        <Link to="/"><img className="img-fluid download_img" src="assets/img/index/Google play.png" width="280"  alt=""/></Link>
                    </div>
                </div>
            </Fragment>
        )
